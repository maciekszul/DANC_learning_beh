...
figure = plt.figure(figsize=(grid_row_n * 4, 5))
...
plt.suptitle("Reach error (coherence + direction)")
plt.savefig("imgs/reach_error_split_by_coh_dir.png", bbox_inches="tight", dpi=300)
plt.close()
...
plt.suptitle("Aim error (coherence+direction)")
plt.savefig("imgs/aim_error_split_by_coh_dir.png", bbox_inches="tight", dpi=300)
plt.close()