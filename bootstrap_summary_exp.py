...
plt.savefig("imgs/reach_error_box_plot_summary_exp.png", bbox_inches="tight", dpi=300)
...
plt.savefig("imgs/aim_error_box_plot_summary_exp.png", bbox_inches="tight", dpi=300)
